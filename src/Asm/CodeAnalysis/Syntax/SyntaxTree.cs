...
internal sealed class SyntaxTree {
    ...
    private delegate void ParseHandler(
        SyntaxTree syntaxTree, out CompilationUnitSyntax root, out AraDiagnosticQueue diagnostics
    );
    ...
    /// </summary>
    internal AraDiagnosticQueue diagnostics;
    ...
    internal static ImmutableArray<SyntaxToken> ParseTokens(
        string text, out AraDiagnosticQueue diagnostics, bool includeEOF = false) {
        var sourceText = SourceText.From(text);
    ...
    /// <returns>SyntaxTokens in order.</returns>
    internal static ImmutableArray<SyntaxToken> ParseTokens(
        SourceText text, out AraDiagnosticQueue diagnostics, bool includeEOF = false) {
        var tokens = new List<SyntaxToken>();

        void ParseTokens(SyntaxTree syntaxTree, out CompilationUnitSyntax root, out AraDiagnosticQueue diagnostics) {
            root = null;
