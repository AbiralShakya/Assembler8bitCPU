...
public sealed class GetChildrenGenerator : ISourceGenerator {
    ...
    public void Execute(GeneratorExecutionContext context) {
        ...
        var separatedSyntaxListType =
            compilation.GetTypeByMetadataName("Asm.CodeAnalysis.Syntax.SeparatedSyntaxList`1");
        var syntaxListType =
            compilation.GetTypeByMetadataName("Asm.CodeAnalysis.Syntax.SyntaxList`1");
        var nodeType = compilation.GetTypeByMetadataName("Asm.CodeAnalysis.Syntax.SyntaxNode");
